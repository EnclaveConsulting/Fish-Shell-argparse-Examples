...
function foofunc
    ...
    set --append options 'x/xray='
    set --append options 'y/year=?'
    set --append options 'h/help'
...
# Instead of appending to the $options variable as
# shown above, the fish_opt command may be used.
