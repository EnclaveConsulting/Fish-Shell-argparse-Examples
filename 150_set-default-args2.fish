...
function foofunc
    ...
    set --query --function _flag_name    ; and set name $_flag_name
    set --query --function _flag_year    ; and set year $_flag_year    
    set --query --function _flag_verbose ; and set verbose yes
